...
| AMD gfx906 | 4× MI50 / Pro VII | чистое декодирование цели | выкл | 69.92 (контекст 512, фиксированный поток) | v1.2: префилл внутри сервера, реальные промпты 1K / 8K / 32K — см. amd-gfx906/docs/BENCHMARKS.md §2b | текущий (v1.2) |
